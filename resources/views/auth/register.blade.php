						...
						<form method="POST" action="{{ route('register') }}">
							...
							<div class="fv-row mb-8">
								...
								<div class="mt-4">
									...
									<x-text-input id="name" class="block mt-1 w-full inp" type="text" name="name" :value="old('name')" required autofocus />
								...
								<div class="mt-4">
									...
									<x-text-input id="email" class="block mt-1 w-full inp" type="email" name="email" :value="old('email')" required />
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										...
										<div class="mt-4">
											...
											<x-text-input id="password" class="block mt-1 w-full inp" type="password" name="password" required autocomplete="new-password" />

											<x-input-error :messages="$errors->get('password')" class="mt-2" />
										</div>

										<span class="btn btn-sm btn-icon position-absolute translate-middle top-50 end-0 me-n2" data-kt-password-meter-control="visibility">
											<i class="bi bi-eye-slash fs-2 pass"></i>
											<i class="bi bi-eye fs-2 d-none pass"></i>
										</span>
									</div>
									<!--end::Input wrapper-->
									<!--begin::Meter-->
							...
							<div class="fv-row mb-8">
								...
								<div class="mt-4">
									...
									<x-text-input id="password_confirmation" class="block mt-1 w-full inp" type="password" name="password_confirmation" required />
