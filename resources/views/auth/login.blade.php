						...
						<form method="POST" action="{{ route('login') }}">
							...
							<div class="fv-row mb-8">
								...
								<div>
									...
									<input class="inp1" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus />
							...
							<div class="fv-row mb-3">
								...
								<div class="mt-4">
									...
									<input class="inp2" id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
